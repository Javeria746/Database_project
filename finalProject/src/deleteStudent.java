    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
       ...
       System.out.println("driver connected");
        ...
        System.out.println("statement created");
         st.executeUpdate("delete  from student where student_id = '"+search.getText()+"'");
        ...
        {
        System.out.println(e);//ab?? kia masla h? fk wla  hn teacher mn wo nhi h table ko alter krk hoskta h?kya??ye masla hal   wo jo condition hte h cascade on delete null...wo nhn kiya tha??kiya to thasql file dikhaoun?..han ok
        }
